...
const generateFeatures = (index) => {
  ...
  const removeItem = clonedOfferFeatures.querySelectorAll('.popup__feature').forEach((item) => {
...
const generateLodgingPhotos = (index) => {
  ...
  console.log(offerLodgingPhotosList.length);
...
const generateAvatar = (index) => {
  ...
  // console.log(generateLodgingPhotos(0));
  // mapCanvas.appendChild(generateLodgingPhotos(0));
